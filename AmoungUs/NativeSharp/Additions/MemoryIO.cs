...
namespace NativeSharp {
	...
	public unsafe sealed class Pointer {
		...
		/// <summary>
		/// Module name。若 <see cref="BaseAddress"/> 为 <see langword="null"/>，下次使用当前pointer实例获取Address时，<see cref="BaseAddress"/> 将被设置为 <see cref="ModuleName"/> 对应的句柄（模块Base address）
		/// </summary>
		...
		/// <param name="offsets">multi-level offset</param>
	...
	unsafe partial class NativeProcess {
		...
		/// <param name="address">Address</param>
		/// <param name="value">值</param>
		/// <param name="startIndex">从 <paramref name="value"/> 的指定offset处开始</param>
